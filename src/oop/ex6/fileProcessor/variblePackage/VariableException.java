...
/**abstract class for variable exceptions*/
public abstract class VariableException extends Exception{
    ...
    /**exception for the case of illegal variable name*/
    ...
    /**exception in case problems with final vars. gets message*/
    static class FinalException extends VariableException {
        ...
        /**exception in case we try to assert variable with wrong type*/
